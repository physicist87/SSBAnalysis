#ifndef TtFullLepKinSolver_hpp
#define TtFullLepKinSolver_hpp
...
class TtFullLepKinSolver {
   ...
   ///
      ...
      ///
      NeutrinoSolution getNuSolution( TLorentzVector LV_l, TLorentzVector LV_l_, 
                      			          TLorentzVector LV_b, TLorentzVector LV_b_ ); 
			void SKTEST();
			void SKTEST1( const TLorentzVector al );
      void FindCoeff( const TLorentzVector al,   const TLorentzVector l, const TLorentzVector b_al, 
                      const TLorentzVector b_l,  const double mt,        const double mat, 
                      const double pxboost,      const double pyboost,   double* q_coeff           );
      ///
   
      void TopRec( const TLorentzVector al,  const TLorentzVector l,
